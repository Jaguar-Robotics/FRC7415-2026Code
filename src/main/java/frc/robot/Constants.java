...
public class Constants {
    ...
    public static abstract class HopperConstants {
        ...
        public static abstract class PowerManagerConstants{
            ...
            public static final int[] Outtake =     {25, 10, 10, 25, 35, 60, 30, 30};
            public static final int[] StillScore =  {25, 50, 40, 30, 30, 30, 20, 30};
            public static final int[] SOTMScore =   {20, 55, 40, 30, 30, 40, 20, 30};
            public static final int[] TurboDrive =  {70, 10, 10, 10, 10, 10, 10, 20}; //drive supa fast
            public static final int[] BeastMode =   {18, 65, 55, 45, 45, 10, 10, 20}; //shooting in last X sec of match, prioritizes feed and shooter
            public static final int[] IntakeMode =  {30, 10, 10, 10, 20, 65, 40, 20}; //mega intake mode

            public static final int BeastModeTimeLimit = 6; //with this many secconds left in the match will beast mode activate while shooting
        }
