...
public class TunerConstants {
    ...
    private static final TalonFXConfiguration driveInitialConfigs = new TalonFXConfiguration().withCurrentLimits(new CurrentLimitsConfigs().withSupplyCurrentLimit(Amps.of(37.5)).withSupplyCurrentLimitEnable(true)); //supply of 52.5
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0.035888671875);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-0.373046875);
